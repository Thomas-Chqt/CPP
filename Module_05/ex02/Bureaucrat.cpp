...
/*   Updated: 2023/11/06 14:44:55 by tchoquet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm(AForm &form) const
{
    ...
    {
        std::cout << this->name << " couldn’t sign " << form.getName() << " due to unknown exception (" << e.what() << ")" << std::endl;
    }
}
...
void Bureaucrat::executeForm(const AForm &form) const
{
    ...
    {
        std::cout << this->name << " couldn’t execute " << form.getName() << " due to unknown exception (" << e.what() << ")" << std::endl;
    }
}
