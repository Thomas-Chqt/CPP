...
/*   Updated: 2023/09/13 23:56:21 by tchoquet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	#ifdef DEBUG
		std::cout << "Int constructor called (Fixed)" << std::endl;
	#endif // DEBUG
}
...
{
	#ifdef DEBUG
		std::cout << "Float constructor called (Fixed)" << std::endl;
	#endif // DEBUG	
}
...
Fixed& Fixed::operator=(const Fixed& copy)
{
	...
	{
		#ifdef DEBUG
			std::cout << "Copy assignment operator called but nothing done (Fixed)" << std::endl;
		#endif // DEBUG
	}
